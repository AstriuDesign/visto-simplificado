...
function Documents() {
    ...
    const [passport_number, setPassportNumber] = useState(''); // Inicialize o estado local com uma string vazia

    const handlePassportNumberChange = (event) => {
    setPassportNumber(event.target.value); // Atualize o estado com o valor do campo de texto
    updateData({passport_number: event.target.value})
    };
    
    const [other_passport_type, setOtherPassportType] = useState(''); // Inicialize o estado local com uma string vazia

    const handleOtherPassportTypeChange = (event) => {
    setOtherPassportType(event.target.value); // Atualize o estado com o valor do campo de texto
    updateData({other_passport_type: event.target.value})
    };

    const [passport_stolen_number, setPassportStolenNumber] = useState(''); // Inicialize o estado local com uma string vazia

    const handlePassportStolenNumberChange = (event) => {
    setPassportStolenNumber(event.target.value); // Atualize o estado com o valor do campo de texto
    updateData({passport_stolen_number: event.target.value})
    };
                ...
                <div className="padding-documents">
                    <div>
                        ...
                        <div className="padding-bottom-1">
                            ...
                            variant="outlined"
                            value={data.other_passport_type} 
                            onChange={handleOtherPassportTypeChange}
                            />
                        </div>
                    </div>
                </div>
                    ...
                    <div className="div-2-inputs-work">
                        <div>
                            ...
                            <div className="padding-bottom-1">
                                ...
                                variant="outlined"
                                value={data.passport_stolen_number}
                                onChange={handlePassportStolenNumberChange} 
                                />
                            </div>
                        </div>
                        <div>
