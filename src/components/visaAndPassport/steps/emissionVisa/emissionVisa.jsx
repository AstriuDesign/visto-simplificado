...
function EmissionVisa() {  
    ...
    const [visa_number, setVisaNumber] = useState(''); // Inicialize o estado local com uma string vazia

    const handleVisaNumberChange = (event) => {
    setVisaNumber(event.target.value); // Atualize o estado com o valor do campo de texto
    updateData({visa_number: event.target.value})
    };
