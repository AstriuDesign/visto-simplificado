...
function Payer() {
    ...
    const [payer_name, setPayerName] = useState(''); // Inicialize o estado local com uma string vazia

    const handlePayerNameChange = (event) => {
    setPayerName(event.target.value); // Atualize o estado com o valor do campo de texto
    updateData({payer_name: event.target.value})
    };


    const [payer_last_name, setPayerLastName] = useState(''); // Inicialize o estado local com uma string vazia

    const handlePayerLastNameChange = (event) => {
    setPayerLastName(event.target.value); // Atualize o estado com o valor do campo de texto
    updateData({payer_last_name: event.target.value})
    };

    const [payer_adress, setPayerAdress] = useState(''); // Inicialize o estado local com uma string vazia

    const handlePayerAdressChange = (event) => {
    setPayerAdress(event.target.value); // Atualize o estado com o valor do campo de texto
    updateData({payer_adress: event.target.value})
    };

    const [payer_cep, setPayerCep] = useState(''); // Inicialize o estado local com uma string vazia

    const handlePayerCepChange = (event) => {
    setPayerCep(event.target.value); // Atualize o estado com o valor do campo de texto
    updateData({payer_cep: event.target.value})
    };
    
    const [payer_phone_number, setPayerPhoneNumber] = useState(''); // Inicialize o estado local com uma string vazia

    const handlePayerPhoneNumberChange = (event) => {
    setPayerPhoneNumber(event.target.value); // Atualize o estado com o valor do campo de texto
    updateData({payer_phone_number: event.target.value})
    };

    const [payer_email, setPayerEmail] = useState(''); // Inicialize o estado local com uma string vazia

    const handlePayerEmailChange = (event) => {
    setPayerEmail(event.target.value); // Atualize o estado com o valor do campo de texto
    updateData({payer_email: event.target.value})
    };
                        ...
                        <div className="div-1-inputs-marital">
                            ...
                            <div>
                                ...
                                <div className="padding-bottom-1">
                                    ...
                                    variant="outlined"
                                    value={data.payer_last_name} 
                                    onChange={handlePayerLastNameChange}
                                    />
                                </div>
                            </div>
                            <div>
                        ...
                        <div className="div-2-inputs-work">
                            <div>
                                ...
                                <div className="padding-bottom-1">
                                    ...
                                    variant="outlined"
                                    value={data.payer_adress}
                                    onChange={handlePayerAdressChange} 
                                    />
                                </div>
                            </div>
                            <div>
                                ...
                                <div className="padding-bottom-1">
                                    <InputMask
                                        mask="99999-999"
                                        maskChar=""
                                        value={data.payer_cep}
                                        onChange={handlePayerCepChange}
                                    >
