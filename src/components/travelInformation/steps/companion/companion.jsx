...
function Companion() {
    ...
    const [accompanying_name, setAccompanyingName] = useState(''); // Inicialize o estado local com uma string vazia

    const handleAccompanyingNameChange = (event) => {
    setAccompanyingName(event.target.value); // Atualize o estado com o valor do campo de texto
    updateData({accompanying_name: event.target.value})
    };

    const [accompanying_last_name, setAccompanyingLastName] = useState(''); // Inicialize o estado local com uma string vazia

    const handleAccompanyingLastNameChange = (event) => {
    setAccompanyingLastName(event.target.value); // Atualize o estado com o valor do campo de texto
    updateData({accompanying_last_name: event.target.value})
    };

    const [group_name, setGroupName] = useState(''); // Inicialize o estado local com uma string vazia

    const handleGroupNameChange = (event) => {
    setGroupName(event.target.value); // Atualize o estado com o valor do campo de texto
    updateData({group_name: event.target.value})
    };
                                ...
                                <div>
                                    ...
                                    <div className="padding-bottom-1">
                                        <TextField
                                            ...
                                            variant="outlined"
                                            value={data.accompanying_name}
                                            onChange={handleAccompanyingNameChange}
                                        />
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div className="padding-bottom-1">
                                        <TextField
                                            ...
                                            variant="outlined"
                                            value={data.accompanying_last_name}
                                            onChange={handleAccompanyingLastNameChange}
                                        />
                                    </div>
                                </div>
                            </div>
