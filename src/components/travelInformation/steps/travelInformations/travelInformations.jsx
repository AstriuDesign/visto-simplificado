...
function TravelInformations() {
    ...
    const [duration_travel, setDurationTravel] = useState(''); // Inicialize o estado local com uma string vazia

    const handleDurationTravelChange = (event) => {
    setDurationTravel(event.target.value); // Atualize o estado com o valor do campo de texto
    updateData({duration_travel: event.target.value})
    };

    const [hosting_address, setHosingAddress] = useState(''); // Inicialize o estado local com uma string vazia

    const handleHostingAddressChange = (event) => {
    setHosingAddress(event.target.value); // Atualize o estado com o valor do campo de texto
    updateData({hosting_address: event.target.value})
    };

    const [hosting_cep, setHosingCep] = useState(''); // Inicialize o estado local com uma string vazia

    const handleHostingCepChange = (event) => {
    setHosingCep(event.target.value); // Atualize o estado com o valor do campo de texto
    updateData({hosting_Cep: event.target.value})
    };
                ...
                <div className="div-2-inputs-work">
                    ...
                    <div>
                        ...
                        <div className="padding-bottom-1">
                            ...
                            placeholder="Ex: 5" 
                            variant="outlined"
                            value={data.duration_travel}
                            onChange={handleDurationTravelChange} 
                            />
                        </div>
                    </div>
                </div>
                <div className="div-1-inputs-marital">
                    <div>
                        ...
                        <div className="padding-bottom-1">
                            ...
                            variant="outlined"
                            value={data.hosting_address}
                            onChange={handleHostingAddressChange} 
                            />
                        </div>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div className="padding-bottom-1">
                            <InputMask
                                mask="99999-999"
                                maskChar=""
                                value={data.hosting_Cep}
                                onChange={handleHostingCepChange}
                            >
