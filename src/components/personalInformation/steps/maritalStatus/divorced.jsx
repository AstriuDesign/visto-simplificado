...
function Divorced() {
    ...
    const [exhusband_name, setExHusbandName] = useState(''); // Inicialize o estado local com uma string vazia

    const handleExHusbandNameChange = (event) => {
    setExHusbandName(event.target.value); // Atualize o estado com o valor do campo de texto
    updateData({exhusband_name: event.target.value})
    };

    const [last_name_exhusband, setLastNameExHusband] = useState(''); // Inicialize o estado local com uma string vazia

    const handleLastNameExHusbandChange = (event) => {
    setExHusbandName(event.target.value); // Atualize o estado com o valor do campo de texto
    updateData({last_name_exhusband: event.target.value})
    };
                ...
                <div className="div-1-inputs-marital">
                    <div>
                        ...
                        <div className="padding-bottom-1">
                            ...
                            variant="outlined"
                            value={data.exhusband_name} 
                            onChange={handleExHusbandNameChange}
                            />
                        </div>
                    </div>
                    <div>
                        ...
                        <div className="padding-bottom-1">
                            ...
                            variant="outlined"
                            value={data.last_name_exhusband} 
                            onChange={handleLastNameExHusbandChange}
                            />
                        </div>
                    </div>
                    <div>
