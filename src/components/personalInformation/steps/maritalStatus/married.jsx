...
function Married() {
    ...
    const [married_name, setMarriedName] = useState(''); // Inicialize o estado local com uma string vazia

    const handleMarriedNameChange = (event) => {
    setMarriedName(event.target.value); // Atualize o estado com o valor do campo de texto
    updateData({married_name: event.target.value})
    };


    const [married_last_name, setMarriedLastName] = useState(''); // Inicialize o estado local com uma string vazia

    const handleMarriedLastNameChange = (event) => {
    setMarriedLastName(event.target.value); // Atualize o estado com o valor do campo de texto
    updateData({married_last_name: event.target.value})
    };

    const [married_adress, setMarriedAdress] = useState(''); // Inicialize o estado local com uma string vazia

    const handleMarriedAdressChange = (event) => {
    setMarriedAdress(event.target.value); // Atualize o estado com o valor do campo de texto
    updateData({married_adress: event.target.value})
    };

    const [complement_married_adress, setComplementMarriedAdress] = useState(''); // Inicialize o estado local com uma string vazia

    const handleComplementMarriedAdressChange = (event) => {
    setComplementMarriedAdress(event.target.value); // Atualize o estado com o valor do campo de texto
    updateData({complement_married_adress: event.target.value})
    };

    const [cep_married, setCepMarried] = useState(''); // Inicialize o estado local com uma string vazia

    const handleCepMarriedChange = (event) => {
    setCepMarried(event.target.value); // Atualize o estado com o valor do campo de texto
    updateData({cep_married: event.target.value})
    };
                ...
                <div className="div-1-inputs-marital">
                    <div>
                        ...
                        <div className="padding-bottom-1">
                            ...
                            variant="outlined"
                            value={data.married_name}
                            onChange={handleMarriedNameChange} 
                            />
                        </div>
                    </div>
                    <div>
                        ...
                        <div className="padding-bottom-1">
                            ...
                            variant="outlined"
                            value={data.married_last_name} 
                            onChange={handleMarriedLastNameChange}
                            />
                        </div>
                    </div>
                    <div>
                ...
                <div className="div-2-inputs-marital">
                    <div>
                        ...
                        <div className="padding-bottom-1">
                            ...
                            variant="outlined"
                            value={data.married_adress} 
                            onChange={handleMarriedAdressChange}
                            />
                        </div>
                    </div>
                    <div>
                        ...
                        <div className="padding-bottom-1">
                            ...
                            variant="outlined"
                            value={data.complement_married_adress}
                            onChange={handleComplementMarriedAdressChange} 
                            />
                        </div>
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <div className="padding-bottom-1">
                            <InputMask
                                mask="99999-999"
                                maskChar=""
                                value={data.cep_married}  
                                onChange={handleCepMarriedChange}      
                            >
