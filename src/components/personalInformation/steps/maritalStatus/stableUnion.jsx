...
function StableUnion() {
    ...
    const [companion_name, setCompaniondName] = useState(''); // Inicialize o estado local com uma string vazia

    const handlCompaniondNameChange = (event) => {
    setCompaniondName(event.target.value); // Atualize o estado com o valor do campo de texto
    updateData({companion_name: event.target.value})
    };


    const [companion_last_name, setCompanionLastName] = useState(''); // Inicialize o estado local com uma string vazia

    const handlCompanionLastNameChange = (event) => {
    setCompanionLastName(event.target.value); // Atualize o estado com o valor do campo de texto
    updateData({companion_last_name: event.target.value})
    };

    const [companion_adress, setCompanionAdress] = useState(''); // Inicialize o estado local com uma string vazia

    const handleCompanionAdressChange = (event) => {
    setCompanionAdress(event.target.value); // Atualize o estado com o valor do campo de texto
    updateData({companion_adress: event.target.value})
    };

    const [complement_companion_adress, setComplementCompanionAdress] = useState(''); // Inicialize o estado local com uma string vazia

    const handleComplementCompanionAdressChange = (event) => {
    setComplementCompanionAdress(event.target.value); // Atualize o estado com o valor do campo de texto
    updateData({complement_companion_adress: event.target.value})
    };

    const [cep_companion, setCepCompanion] = useState(''); // Inicialize o estado local com uma string vazia

    const handleCepCompanionChange = (event) => {
    setCepCompanion(event.target.value); // Atualize o estado com o valor do campo de texto
    updateData({cep_companion: event.target.value})
    };
                ...
                <div className="div-1-inputs-marital">
                    <div>
                        ...
                        <div className="padding-bottom-1">
                            ...
                            onChange={handlCompaniondNameChange} 
                            />
                        </div>
                    </div>
                    <div>
                        ...
                        <div className="padding-bottom-1">
                            ...
                            variant="outlined"
                            value={data.companion_last_name} 
                            onChange={handlCompanionLastNameChange}
                            />
                        </div>
                    </div>
                    <div>
                    ...
                    <div className="div-2-inputs-marital">
                        <div>
                            ...
                            <div className="padding-bottom-1">
                                ...
                                variant="outlined"
                                value={data.companion_adress} 
                                onChange={handleCompanionAdressChange}
                                />
                            </div>
                        </div>
                        <div>
                            ...
                            <div className="padding-bottom-1">
                                ...
                                variant="outlined"
                                value={data.complement_companion_adress} 
                                onChange={handleComplementCompanionAdressChange}
                                />
                            </div>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div className="padding-bottom-1">
                                <InputMask
                                    mask="99999-999"
                                    maskChar=""
                                    value={data.cep_companion}
                                    onChange={handleCepCompanionChange}
                                >
