...
function Widow() {
    ...
    const [widow_name, setWidowName] = useState(''); // Inicialize o estado local com uma string vazia

    const handleWidowNameChange = (event) => {
    setWidowName(event.target.value); // Atualize o estado com o valor do campo de texto
    updateData({widow_name: event.target.value})
    };
    const [widow_last_name, setWidowLastName] = useState('');

    const handleWidowLastNameChange = (event) => {
        setWidowLastName(event.target.value); // Atualize o estado com o valor do campo de texto
        updateData({widow_last_name: event.target.value})
        };
                    ...
                    <div className="div-2-inputs-marital">
                        <div>
                            ...
                            <div className="padding-bottom-1">
                                ...
                                variant="outlined"
                                value={data.widow_name}
                                onChange={handleWidowNameChange} 
                                />
                            </div>
                        </div>
                        <div>
                            ...
                            <div className="padding-bottom-1">
                                ...
                                variant="outlined"
                                value={data.widow_last_name}
                                onChange={handleWidowLastNameChange} 
                                />
                            </div>
                        </div>
                    </div>
