...
function InformationResidence(props) {
    ...
    const [home_address, setHomeAdress] = useState(''); // Inicialize o estado local com uma string vazia

    const handleHomeAdressChange = (event) => {
    setHomeAdress(event.target.value); // Atualize o estado com o valor do campo de texto
    updateData({home_address: event.target.value})
    };

    const [complement_home_address, setComplementHomeAdress] = useState(''); // Inicialize o estado local com uma string vazia

    const handleComplementHomeAdressChange = (event) => {
    setComplementHomeAdress(event.target.value); // Atualize o estado com o valor do campo de texto
    updateData({complement_home_address: event.target.value})
    };

    const [home_cep, setHomeCep] = useState(''); // Inicialize o estado local com uma string vazia

    const handleHomeCepChange = (event) => {
    setHomeCep(event.target.value); // Atualize o estado com o valor do campo de texto
    updateData({home_cep: event.target.value})
    };
                ...
                <div className="div-2-inputs-work">
                    ...
                    <div>
                        ...
                        <div className="padding-bottom-1">
                            ...
                            variant="outlined"
                            value={data.complement_home_address} 
                            onChange={handleComplementHomeAdressChange}
                            />
                        </div>
                    </div>
                </div>
